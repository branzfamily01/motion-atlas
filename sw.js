const CACHE='motion-atlas-v3';
const ASSETS=['./','./index.html','./manual.html','./styles.css','./app.js','./motion-data.js','./motion-engine.js','./manifest.webmanifest','./my-hub.json','./icons/icon.svg'];
